...
public class StoryMaster {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StoryMaster it = new StoryMaster();
        it.loadJSON();
    }
    ...
    public void loadJSON() throws IOException, Exception {
        ...
        String savedjsonState = " ";                                                                    //to save the json state
        ...
        while (story.canContinue()) {                                                                 //while there is another line in the story
            ...
            savedjsonState = story.getState().toJson();                                                //save the current state of the json story file (everything.)
        }

        System.err.println(savedjsonState);
        /*
        to load a json saved state:
