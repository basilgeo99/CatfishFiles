 ...
 * @Date 16th May 2019
 *
 *   An entire class dedicated to formatting the text in the windows.
...
public class Appearance {
    ...
    public String drawStrikethrough(int limit, char...patternCharacter){

        /**
         * Returns the strikethrough pattern characters arranged in order as a String
         */
        String result = "";
        while(limit>0) {
